...
const index = () => {
  return (
    <header className="grid font-santoshi text-sm font-medium md:grid-cols-2 md:flex-row md:text-base lg:text-lg">
      <div className="flex items-center gap-2 bg-primary-blue px-6 md:gap-6 lg:bg-transparent lg:px-10">
      ...
      <div className="flex flex-col items-center gap-3 bg-secondary200 px-4 py-3 text-secondary1000 md:flex-row md:gap-6 md:py-0 lg:gap-8">
        <a
